...
class DrVLMGRPOTrainer(Trainer):
    """
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        # loss = (per_token_loss * completion_mask).sum(dim=1).mean() # 251114 ysw edited: GRPO to Dr. GRPO
        total_loss = (per_token_loss * completion_mask).sum()
        normalizer = (per_token_loss.size(0) * self.max_completion_length )# 251114 oyt edited: Dr. GRPO
