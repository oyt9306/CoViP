...
def main():
    ...
    for i in tqdm(range(0, data_size, batch_size)):
        ...
        for j in range(i, i + bs):
            ...
            user_content.append(
                {
                    "type": "text",
                    "text": "What was I doing the last time I told you about my most recent experience with the one in the new image?",
                }
            )
            messages = [
                {
    ...
    save_path = f"lar_responses0_{model_id.split('/')[-1]}.json"
